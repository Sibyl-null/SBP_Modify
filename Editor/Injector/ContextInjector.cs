    ...
    class ContextInjector
    {
        public static void Inject(IBuildContext context, object obj)
        {
            ...
            foreach (FieldInfo field in fields)
            {
                ...
                {
                    context.TryGetContextObject(field.FieldType, out IContextObject contextObject);
        ...
        public static void Extract(IBuildContext context, object obj)
        {
            ...
            foreach (FieldInfo field in fields)
            {
                ...
                if (field.FieldType == typeof(IBuildContext))
                    throw new InvalidOperationException("IBuildContext 字段只能使用 ContextUsage.In.");

                // 将该字段设置回 ContextObject
