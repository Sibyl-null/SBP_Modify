...
namespace UnityEditor.Build.Pipeline
{
    ...
    public static class BuildTasksRunner
    {
        ...
        public static ReturnCode Run(IList<IBuildTask> pipeline, IBuildContext context)
        {
            ...
            if (pipeline == null)
            {
                BuildLogger.LogException(new ArgumentNullException(nameof(pipeline)));
            ...
            if (context == null)
            {
                BuildLogger.LogException(new ArgumentNullException(nameof(context)));
                return ReturnCode.Exception;
            }

            if (context.TryGetContextObject(out IProgressTracker tracker))
